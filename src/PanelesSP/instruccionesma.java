 ...
 * @author USUARIO
 */
public class instruccionesma extends javax.swing.JPanel {
    /**
    ...
    public instruccionesma(String user) {
        initComponents();
        this.name = user;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("4 palabras ocultas relacionadas a nombres de personajes de anime.");
...
sonidosp("/Sonidos/boop.wav");
        panelito.removeAll();
        mediumanime e = new mediumanime(name);//Una instancia
        e.setSize(800, 496);
        e.setLocation(0, 0);
        e.setOpaque(false);
        panelito.add(e);
