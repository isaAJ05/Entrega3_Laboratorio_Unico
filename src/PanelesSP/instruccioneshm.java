 ...
 * @author USUARIO
 */
public class instruccioneshm extends javax.swing.JPanel {
    /**
    ...
    public instruccioneshm(String user) {
        initComponents();
        this.name = user;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("6 palabras ocultas relacionadas a nombres de cantantes reconocidos.");
...
sonidosp("/Sonidos/boop.wav");
        panelito.removeAll();
        hardmusica e = new hardmusica(name);//Una instancia
        e.setSize(800, 496);
        e.setLocation(0, 0);
        e.setOpaque(false);
        panelito.add(e);
