 ...
 * @author USUARIO
 */
public class instruccionesha extends javax.swing.JPanel {
    /**
    ...
    public instruccionesha(String user) {
        initComponents();
        this.name = user;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("6 palabras ocultas relacionadas a nombres de personajes de anime.");
...
sonidosp("/Sonidos/boop.wav");
        panelito.removeAll();
        hardanime e = new hardanime(name);//Una instancia
        e.setSize(800, 496);
        e.setLocation(0, 0);
        e.setOpaque(false);
        panelito.add(e);
