...
public void sonidosp(String cadena) {
    ...
    public hard(String user) {
        ...
        //Tierra
        JButton[] tierra = {boton11, boton12, boton13, boton14, boton15, boton16,};
        //Saturno
        JButton[] saturno = {boton18, boton28, boton38, boton48, boton58, boton68, boton78,};
        //Marte
        JButton[] marte = {boton76, boton66, boton56, boton46, boton36,};
        //Urano
        JButton[] urano = {boton72, boton62, boton52, boton42, boton32,};
        //Venus
        JButton[] venus = {boton88, boton87, boton86, boton85, boton84,};
        //Jupiter
        JButton[] jupiter = {boton81, boton72, boton63, boton54, boton45, boton36, boton27,};

        //Asignacion de letras a texto de la matriz de botones
        for (i = 0; i < 8; i++) {
            for (j = 0; j < 8; j++) {
                botonpresionado(botones[i][j], botones, tierra, saturno, marte, urano, venus, jupiter, chulito1, chulito2, chulito3, chulito4, chulito5, chulito7);
    ...
    private void pistaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pistaActionPerformed
        ...
        if (yaloencontre3 == false&&contp<4) {//pista letra inicial MARTE
            boton76.setBackground(new Color(153, 255, 153));
            sonidosp("/Sonidos/pista.wav");

        } else if (yaloencontre6 == false&&contp<4) {//pista letra inicial JUPITER
            boton81.setBackground(new Color(153, 255, 153));
            sonidosp("/Sonidos/pista.wav");

        } else if (yaloencontre5 == false&&contp<4) {//pista letra final VENUS
            boton84.setBackground(new Color(153, 255, 153));
            sonidosp("/Sonidos/pista.wav");

        } else if (yaloencontre4 == false&&contp<4) {//pista letra final URANO
            boton32.setBackground(new Color(153, 255, 153));
            sonidosp("/Sonidos/pista.wav");

        } else if (yaloencontre1 == false&&contp<4) {//pista letra final tierra
            boton16.setBackground(new Color(153, 255, 153));
            sonidosp("/Sonidos/pista.wav");

        } else if (yaloencontre2 == false&&contp<4) {//pista letra final saturno
