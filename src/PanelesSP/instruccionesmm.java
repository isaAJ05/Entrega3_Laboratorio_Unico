 ...
 * @author USUARIO
 */
public class instruccionesmm extends javax.swing.JPanel {
    /**
    ...
    public instruccionesmm(String user) {
        initComponents();
        this.name = user;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("4 palabras ocultas relacionadas a nombres de cantantes reconocidos.");
        ...
        jLabel2.setText("¡DIVIERTETE JUGANDO LA SOPA DE LETRAS STAR: VERSIÓN MÚSICA!");
        ...
        botonok.setText("OK");
        botonok.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        btnVolver4.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
...
sonidosp("/Sonidos/boop.wav");
        panelito.removeAll();
        mediummusica e = new mediummusica(name);//Una instancia
        e.setSize(800, 496);
        e.setLocation(0, 0);
        e.setOpaque(false);
        panelito.add(e);
